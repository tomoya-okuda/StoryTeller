...
function StoryWriter() {
  ...
  return (
    <div className="flex flex-col px-4 md:px-8">
      <section className="flex-1 flex flex-col items-center border border-purple-300 rounded-md p-4 md:p-10 space-y-2 md:space-y-2">
        <Textarea
          value={story}
      ...
      <section className="flex-1 pb-5 mt-5">
        <div className="flex flex-col-reverse w-full space-y-2 bg-gray-800 rounded-md text-gray-200 font-mono p-4 md:p-10 h-96 overflow-y-auto">
          <div>
            {runFinished === null && (
              <>
